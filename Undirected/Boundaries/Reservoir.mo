...
<p><span style=\"color: #ca8700;\">Note that the energy equation requires the Mass in the system to be positive and will not give valid results otherwise (if the assert of height &gt; 0 fails).</span></p>
</html>"));
end Reservoir;

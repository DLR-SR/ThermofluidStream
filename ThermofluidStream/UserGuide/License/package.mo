...
<h4>License</h4>
<p>
Licensed by the Deutsches Zentrum f&uuml;r Luft- und Raumfahrt e.V. (DLR) under
the 3-Clause BSD License
</p>
<p>
Copyright &copy; 2020-2021, DLR e.V.
</p>
<p>
This Modelica package is free software and the use is completely at your own risk;
it can be redistributed and/or modified under the terms of the 3-Clause BSD license.
For license conditions (including the disclaimer of warranty) visit
https://modelica.org/licenses/modelica-3-clause-bsd.
</p>
<p>
Modelica&reg; is a registered trademark of the Modelica Association.
</p>

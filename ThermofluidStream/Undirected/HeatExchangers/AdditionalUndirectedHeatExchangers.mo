...
package AdditionalUndirectedHeatExchangers
  model DiscretizedCrossFlowHEX2 "v2 of DiscretizedCrossFlowHEX2"
    ...
    extends Undirected.HeatExchangers.Internal.PartialDiscretizedHEX(nCellsParallel=nCells, crossFlow=true);

    Undirected.Processes.FlowResistance flowResistanceA[nCells](
    ...
    Undirected.Topology.JunctionMN junctionMN(
      redeclare package Medium = MediumA,
      N=1,
      M=nCells) annotation (Placement(transformation(
          ...
          rotation=0,
          origin={50,-60})));
    Undirected.Topology.JunctionMN junctionMN1(redeclare package Medium = MediumA, N=nCells) annotation (Placement(transformation(extent={{-60,-70},{-80,-50}})));
...
end AdditionalUndirectedHeatExchangers;

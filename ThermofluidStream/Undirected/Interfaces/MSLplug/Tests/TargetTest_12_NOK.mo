...
model TargetTest_12_NOK
  ...
  Topology.ConnectorInletOutletFore connectorInletOutletFore(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{40,34},{52,46}})));
  ...
  ThermofluidStream.Processes.ConductionElement conductionElement(
    redeclare package Medium = Medium,
    V=0.01,
    resistanceFromAU=false) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-76,10})));
  ...
  ThermofluidStream.FlowControl.Switch switch(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{-16,46},{-4,34}})));
  ...
  Modelica.Fluid.Vessels.ClosedVolume volume(
    ...
    nPorts=2) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={32,10})));
  RearTFS_FluidPortMSL rearTFS_FluidPortMSL annotation (Placement(transformation(
        extent={{-4,-4},{4,4}},
        rotation=-90,
        origin={46,26})));
  RearTFS_FluidPortMSL rearTFS_FluidPortMSL1 annotation (Placement(transformation(
        extent={{-4,-4},{4,4}},
        rotation=90,
        origin={46,-4})));
protected
...
equation
  ...
  connect(flowGenerator_SF.inlet, reservoir.outlet) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(mCV1.outlet, sink.inlet) annotation (Line(
      points={{80,40},{90,40}},
      color={28,108,200},
      thickness=0.5));
  ...
  connect(firstOrder.y, mCV1.setpoint_var) annotation (Line(points={{73.6,0},{70,0},{70,32}}, color={0,0,127}));
  connect(mCV1.inlet, connectorInletOutletFore.outlet) annotation (Line(
      points={{60,40},{52,40}},
      color={28,108,200},
      thickness=0.5));
  ...
  connect(flowGenerator_SF.outlet, conductionElement.inlet) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(stepoint.y, PID.u_m) annotation (Line(points={{-39.4,60},{-38,60},{-38,52},{-26,52},{-26,55.2}}, color={0,0,127}));
  connect(singleSensorSelect.value_out, PID.u_s) annotation (Line(points={{-42,50},{-36,50},{-36,60},{-30.8,60}}, color={0,0,127}));
  connect(connectorInletOutletFore.fore, rearTFS_FluidPortMSL.rearTFS) annotation (Line(
      points={{46,34},{46,30}},
      color={28,108,200},
      thickness=0.5));
  connect(rearTFS_FluidPortMSL1.rearTFS, connectorInletOutletFore1.fore) annotation (Line(
      points={{46,-8},{46,-14}},
      color={28,108,200},
      thickness=0.5));
  connect(rearTFS_FluidPortMSL1.portMSL, volume.ports[1]) annotation (Line(points={{46,0},{46,9},{42,9}}, color={0,127,255}));
  connect(rearTFS_FluidPortMSL.portMSL, volume.ports[2]) annotation (Line(points={{46,22},{46,11},{42,11}}, color={0,127,255}));

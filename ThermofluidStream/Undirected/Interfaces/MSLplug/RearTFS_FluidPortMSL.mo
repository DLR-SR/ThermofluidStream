...
public
  ...
  Modelica.Fluid.Interfaces.FluidPort_b portMSL(redeclare package Medium = Medium)
    "Fluid connector b (positive design flow direction is from port_a to port_b)"   annotation (Placement(transformation(extent={{60,-20},{20,20}}),  iconTransformation(extent={{50,-10},
            {30,10}})));
  ThermofluidStream.Undirected.Interfaces.Rear rearTFS(redeclare package Medium = Medium)

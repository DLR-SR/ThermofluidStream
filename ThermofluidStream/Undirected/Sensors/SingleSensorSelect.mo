...
model SingleSensorSelect "Selectable sensor"
  ...
  final parameter String quantityString=
    ...
    elseif quantity == ThermofluidStream.Sensors.Internal.Types.Quantities.MM_gpmol then  "M in g/mol"
...
protected
  ThermofluidStream.Sensors.Internal.GetQuantityBlock getQuantity(

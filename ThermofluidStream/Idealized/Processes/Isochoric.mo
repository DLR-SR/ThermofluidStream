...
equation
  ...
  annotation (Icon(graphics={
     Text(visible = displayParameters and showOutletSpecification and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed and specifyOutlet and outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Cycle.Isochoric.TemperatureDifference,
       extent={{-150,-70},{150,-100}},
       textColor={0,0,0},
       textString="ΔT = %dT_fixed"),
     Text(visible = displayParameters and showOutletSpecification and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed and specifyOutlet and outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Cycle.Isochoric.OutletTemperature,
       extent={{-150,-70},{150,-100}},
       textColor={0,0,0},
     ...
     Text(visible = not specifyOutlet and not heatFlowSignal == ThermoFluidStreamPlus.Idealized.Types.EnergyFlowSignalMode.Input,
       ...
       textColor={238,46,47}),
     Line(visible = systemSpec == ThermoFluidStreamPlus.Idealized.Types.SystemModel.Flow,
       points={{100,0},{100,-100}},
       color={255,170,85}),
     Ellipse(
       extent={{-56,54},{64,-66}},
     ...
     Polygon(visible = showEnergyFlowDirection,
        ...
        Polygon(visible = showEnergyFlowDirection and systemSpec == ThermoFluidStreamPlus.Idealized.Types.SystemModel.Flow,
          origin={80,-118},
          ...
          pattern=LinePattern.None),
        Text(visible = showEnergyFlowDirection and systemSpec == ThermoFluidStreamPlus.Idealized.Types.SystemModel.Flow,
          origin={62,-138},
          extent={{0,0},{36,36}},

    ...
    Icon(
      graphics={
        ...
        Rectangle(
          ...
          pattern=LinePattern.None),
        Rectangle(
          extent=DynamicSelect(if IconType == ThermofluidStream.Idealized.Types.dTIconType.Heating then {{-44,42},{42,-42}} else {{44,42},{-42,-42}}, if dT > 0 then {{-44,42},{42,-42}} else {{44,42},{-42,-42}}),
          lineColor={28,108,200},
          ...
          pattern=LinePattern.None),
        Rectangle(
          extent=DynamicSelect(if IconType == ThermofluidStream.Idealized.Types.dTIconType.Heating then {{-18,42},{42,-42}} else {{18,42},{-42,-42}}, if dT > 0 then {{-18,42},{42,-42}} else {{18,42},{-42,-42}}),
          lineColor={28,108,200},

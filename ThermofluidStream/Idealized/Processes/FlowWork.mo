...
equation
  ...
  annotation (Icon(graphics={
    Line(visible = boundary == ThermoFluidStreamPlus.Idealized.Types.FlowWorkBoundary.Outlet,
      points={{100,0},{100,-100}},
      color={255,170,85}),
    Line(visible = boundary == ThermoFluidStreamPlus.Idealized.Types.FlowWorkBoundary.Inlet,
      points={{-100,0},{-100,-100}},
      color={255,170,85}),
  ...
  <p>
    ...
    See, for example,
    <a href=\"modelica://ThermoFluidStreamPlus.Idealized.Examples.TUMExercisesThermodynamicCycles.Exercise5TurboChargedDiesel.PolytropicCycle\">Exercise5TurboChargedDiesel.Polytropic</a>.
  </p>

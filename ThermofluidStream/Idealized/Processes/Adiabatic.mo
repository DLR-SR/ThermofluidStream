    ...
    Icon(
      graphics={
        ...
        Text(
          ...
          elseif outletSpec == ThermofluidStream.Idealized.Types.OutletSpecification.Adiabatic.PressureRatio then "pRatio = %pRatio_fixed"
        ...
        Line(
          ...
          color={0,0,127}),
        Polygon(
          origin = DynamicSelect({40,-50}, if P >= 0 then {40,-50} else {-40,-50}),

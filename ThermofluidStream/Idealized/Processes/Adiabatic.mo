...
equation
  ...
  annotation (Icon(graphics={
        ...
        Text(visible= displayParameters and showOutletSpecification and specifyOutlet and outletSpec == ThermoFluidStream.Idealized.Types.OutletSpecification.Flow.Adiabatic.PressureDifference and outletValueSpec == ThermoFluidStream.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="Δp = %dp_fixed"),
        Text(visible= displayParameters and showOutletSpecification and specifyOutlet and outletSpec == ThermoFluidStream.Idealized.Types.OutletSpecification.Flow.Adiabatic.PressureRatio and outletValueSpec == ThermoFluidStream.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="pr = %pr_fixed"),
        Text(visible= displayParameters and showOutletSpecification and specifyOutlet and outletSpec == ThermoFluidStream.Idealized.Types.OutletSpecification.Flow.Adiabatic.OutletPressure and outletValueSpec == ThermoFluidStream.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},

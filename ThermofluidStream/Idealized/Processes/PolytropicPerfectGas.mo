...
equation
  ...
  <ul>
    <li>
      ...
      graphics={
        Text(visible= displayParameters and showOutletSpecification and outletSpec == ThermoFluidStream.Idealized.Types.OutletSpecification.Polytropic.PressureDifference and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="Δp = %dp_fixed"),
        Text(visible= displayParameters and showOutletSpecification and outletSpec == ThermoFluidStream.Idealized.Types.OutletSpecification.Polytropic.PressureRatio and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="pRatio = %pRatio_fixed"),
        Text(visible= displayParameters and showOutletSpecification and outletSpec == ThermoFluidStream.Idealized.Types.OutletSpecification.Polytropic.OutletPressure and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="p_out = %p_out_fixed"),
        Text(visible= displayParameters and showOutletSpecification and outletSpec == ThermoFluidStream.Idealized.Types.OutletSpecification.Polytropic.OutletTemperature and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="T_out = %T_out_fixed"),
        Text(visible= displayParameters and showOutletSpecification and outletSpec == ThermoFluidStream.Idealized.Types.OutletSpecification.Polytropic.CompressionRatio and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="rhoRatio = %rhoRatio_fixed"),
        Text(visible= displayParameters and showOutletSpecification and outletSpec == ThermoFluidStream.Idealized.Types.OutletSpecification.Polytropic.OutletDensity and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="rho_out = %rho_out_fixed"),
        Text(visible= displayParameters and showOutletSpecification and outletSpec == ThermoFluidStream.Idealized.Types.OutletSpecification.Polytropic.OutletSpecificVolume and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="v_out = %v_out_fixed"),
        Text(visible = displayParameters and showProcessSpecification and processValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed and processSpec == ThermoFluidStream.Idealized.Types.PolytropicProcessSpecification.PolytropicEfficiency,
          extent={{-150,-140},{150,-110}},
          textColor={0,0,0},
          textString="eta_pol = %eta_pol_fixed"),
        Text(visible = displayParameters and showProcessSpecification and processValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed and processSpec == ThermoFluidStream.Idealized.Types.PolytropicProcessSpecification.PolytropicExponent,
          extent={{-150,-140},{150,-110}},
          textColor={0,0,0},
          textString="n = %n_fixed"),
        Text(visible = displayParameters and showProcessSpecification and processValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed and processSpec == ThermoFluidStream.Idealized.Types.PolytropicProcessSpecification.IsentropicEfficiency,
          extent={{-150,-140},{150,-110}},
          textColor={0,0,0},
          textString="eta_is = %eta_is_fixed"),
        Text(visible = displayParameters and showProcessSpecification and processValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed and processSpec == ThermoFluidStream.Idealized.Types.PolytropicProcessSpecification.OutletPressure,
          extent={{-150,-140},{150,-110}},
          textColor={0,0,0},
          textString="p_out = %p_out_fixed"),
        Text(visible = displayParameters and showProcessSpecification and processValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed and processSpec == ThermoFluidStream.Idealized.Types.PolytropicProcessSpecification.OutletTemperature,
          extent={{-150,-140},{150,-110}},
          textColor={0,0,0},
          textString="T_out = %T_out_fixed"),
        Line(visible = not outletSpec == ThermoFluidStream.Idealized.Types.OutletSpecification.Polytropic.Unspecified and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Prescribed,

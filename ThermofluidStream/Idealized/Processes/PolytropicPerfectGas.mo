...
model PolytropicPerfectGas "Polytropic process, perfect gas"
  ...
  parameter SI.AbsolutePressure p_inf = 1e5 "Ambient pressure (cycle process)"
    annotation(Dialog(group = "Closed cycle (periodic) process",
  ...
  Medium.Density rho_in = Medium.density(inlet.state) "Inlet density"
    annotation(HideResult = not systemSpec == SystemSpecification.Cycle or not (outletSpec == OutletSpecification.CompressionRatio or outletSpec == OutletSpecification.OutletDensity or outletSpec == OutletSpecification.OutletSpecificVolume));
  ...
  Medium.SpecificHeatCapacity cp = Medium.specificHeatCapacityCp(inlet.state) "Specific isobaric heat capacity"
    annotation(HideResult = systemSpec == SystemSpecification.Cycle);
  ...
  SI.SpecificEnthalpy w_s = dh "Specific shaft work"
    annotation(HideResult = systemSpec == SystemSpecification.Cycle); // More precisely dh = w_s + q
  ...
  SI.SpecificEnergy w_i = du "Specific internal work"
    annotation(HideResult = systemSpec == SystemSpecification.Flow); // More precisely du = w_i + q
...
protected
  ...
  Real rhoRatio = rho_out/rho_in "Compression ratio rho_out/rho_in"
    annotation(HideResult = not systemSpec == SystemSpecification.Cycle or not (outletSpec == OutletSpecification.CompressionRatio or outletSpec == OutletSpecification.OutletDensity or outletSpec == OutletSpecification.OutletSpecificVolume));
  ...
  Real log_rhoRatio = log(rhoRatio) "=log(rhoRatio)"
    annotation(HideResult = not systemSpec == SystemSpecification.Cycle or not (outletSpec == OutletSpecification.CompressionRatio or outletSpec == OutletSpecification.OutletDensity or outletSpec == OutletSpecification.OutletSpecificVolume)); //required to avoid implicit nonlinear equations
...
equation
  ...
  <ul>
    <li>
      ...
      graphics={
        Text(visible= displayParameters and showOutletSpecification and outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.PressureDifference and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="Δp = %dp_fixed"),
        Text(visible= displayParameters and showOutletSpecification and outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.PressureRatio and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="pRatio = %pRatio_fixed"),
        Text(visible= displayParameters and showOutletSpecification and outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.OutletPressure and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="p_out = %p_out_fixed"),
        Text(visible= displayParameters and showOutletSpecification and outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.OutletTemperature and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="T_out = %T_out_fixed"),
        Text(visible= displayParameters and showOutletSpecification and outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.CompressionRatio and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="rhoRatio = %rhoRatio_fixed"),
        Text(visible= displayParameters and showOutletSpecification and outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.OutletDensity and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="rho_out = %rho_out_fixed"),
        Text(visible= displayParameters and showOutletSpecification and outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.OutletSpecificVolume and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed,
          extent={{-150,-100},{150,-70}},
          textColor={0,0,0},
          textString="v_out = %v_out_fixed"),
        Text(visible = displayParameters and showProcessSpecification and processValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed and processSpec == ThermoFluidStreamPlus.Idealized.Types.PolytropicProcessSpecification.PolytropicEfficiency,
          extent={{-150,-140},{150,-110}},
          textColor={0,0,0},
          textString="eta_pol = %eta_pol_fixed"),
        Text(visible = displayParameters and showProcessSpecification and processValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed and processSpec == ThermoFluidStreamPlus.Idealized.Types.PolytropicProcessSpecification.PolytropicExponent,
          extent={{-150,-140},{150,-110}},
          textColor={0,0,0},
          textString="n = %n_fixed"),
        Text(visible = displayParameters and showProcessSpecification and processValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed and processSpec == ThermoFluidStreamPlus.Idealized.Types.PolytropicProcessSpecification.IsentropicEfficiency,
          extent={{-150,-140},{150,-110}},
          textColor={0,0,0},
          textString="eta_is = %eta_is_fixed"),
        Text(visible = displayParameters and showProcessSpecification and processValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed and processSpec == ThermoFluidStreamPlus.Idealized.Types.PolytropicProcessSpecification.OutletPressure,
          extent={{-150,-140},{150,-110}},
          textColor={0,0,0},
          textString="p_out = %p_out_fixed"),
        Text(visible = displayParameters and showProcessSpecification and processValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Fixed and processSpec == ThermoFluidStreamPlus.Idealized.Types.PolytropicProcessSpecification.OutletTemperature,
          extent={{-150,-140},{150,-110}},
          textColor={0,0,0},
          textString="T_out = %T_out_fixed"),
        Line(visible = not outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.Unspecified and outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Prescribed,
          points={{100,0},{100,-100}},
          color={0,0,127}),
        Line(visible = processValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Prescribed,
        ...
        Ellipse(visible = not outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.Unspecified  and powerSignal == ThermoFluidStreamPlus.Idealized.Types.EnergyFlowSignalMode.Input,
          extent={{-98,58},{-62,22}},pattern=LinePattern.None,fillColor={170,213,255},fillPattern=FillPattern.Solid),
        Rectangle(visible = not outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.Unspecified and powerSignal == ThermoFluidStreamPlus.Idealized.Types.EnergyFlowSignalMode.Input,
        ...
        Ellipse(
          ...
          fillPattern=FillPattern.Solid),
        Text(visible = systemSpec == ThermoFluidStreamPlus.Idealized.Types.SystemModel.Cycle,
          extent= {{-40,20},{40,-20}},
          textColor={28,108,200},
          textString="n-c"),
        Text(visible = (outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.Unspecified and not powerSignal == ThermoFluidStreamPlus.Idealized.Types.EnergyFlowSignalMode.Input)
          or (outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.Unspecified and powerSignal == ThermoFluidStreamPlus.Idealized.Types.EnergyFlowSignalMode.Input and processSpec == ThermoFluidStreamPlus.Idealized.Types.PolytropicProcessSpecification.OutletTemperature)
          or (outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.OutletTemperature and processSpec == ThermoFluidStreamPlus.Idealized.Types.PolytropicProcessSpecification.OutletTemperature)
          or ((outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.PressureDifference or outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.PressureRatio or outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.OutletPressure) and processSpec == ThermoFluidStreamPlus.Idealized.Types.PolytropicProcessSpecification.OutletPressure),
          extent={{-150,100},{150,60}},
          textString= "can't be balanced",
          textColor={238,46,47}),
        Polygon(visible=
          (outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.Unspecified and not powerSignal == ThermoFluidStreamPlus.Idealized.Types.EnergyFlowSignalMode.Input)
          or (outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.Unspecified and powerSignal == ThermoFluidStreamPlus.Idealized.Types.EnergyFlowSignalMode.Input and processSpec == ThermoFluidStreamPlus.Idealized.Types.PolytropicProcessSpecification.OutletTemperature)
          or (outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.OutletTemperature and processSpec == ThermoFluidStreamPlus.Idealized.Types.PolytropicProcessSpecification.OutletTemperature)
          or ((outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.PressureDifference or outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.PressureRatio or outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.OutletPressure) and processSpec == ThermoFluidStreamPlus.Idealized.Types.PolytropicProcessSpecification.OutletPressure),
          points={{-6,44},{-22,-8},{-2,-8},{-18,-50},{28,8},{2,8},{20,44},{-6,44}},
          ...
          fillColor={238,46,47},
          pattern=LinePattern.None),
        Polygon(visible = powerSignal == ThermoFluidStreamPlus.Idealized.Types.EnergyFlowSignalMode.Input and not outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.Unspecified and (outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Prescribed or processValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Prescribed),
          points = {{0,58},{-20,18},{20,18},{0,58}},
          lineColor = {244,125,35},
          lineThickness=1),
        Text(visible = powerSignal == ThermoFluidStreamPlus.Idealized.Types.EnergyFlowSignalMode.Input and not outletSpec == ThermoFluidStreamPlus.Idealized.Types.OutletSpecification.Polytropic.Unspecified and (outletValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Prescribed or processValueSpec == ThermoFluidStreamPlus.Types.ValueSpecification.Prescribed),
          extent = {{-10,42},{10,22}},
        ...
        Text(visible = systemSpec == ThermoFluidStreamPlus.Idealized.Types.SystemModel.Flow,
          extent={{-20,20},{20,-20}},
          textColor={28,108,200},
          textString="n"),

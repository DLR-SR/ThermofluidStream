...
model SplitterT2 "Example - SplitterT2"
  ...
  .ThermofluidStream.Idealized.Sources.MassFlowRate massFlowRate1(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{30,90},{50,70}})));
  ThermofluidStream.Boundaries.Source source2(
    redeclare package Medium = Medium,
    p0_par=100000,
    T0_par=293.15) annotation (Placement(transformation(extent={{-110,-70},{-90,-50}})));
  .ThermofluidStream.Idealized.Sources.Sink_free sinkB2(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{-20,-70},{0,-50}})));
  ...
  .ThermofluidStream.Idealized.Sources.MassFlowRate massFlowRateA2(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{-50,-110},{-30,-90}})));
  .ThermofluidStream.Idealized.Sources.MassFlowRate massFlowRateB1(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{-50,-50},{-30,-70}})));

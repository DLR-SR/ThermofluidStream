...
model SplitterT1 "Example - SplitterT1"
  ...
  .ThermofluidStream.Idealized.Boundaries.MassFlowRate massFlowRate1(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{30,70},{50,50}})));
  ThermofluidStream.Boundaries.Source source2(
    redeclare package Medium = Medium,
    p0_par=100000,
    T0_par=293.15) annotation(Placement(transformation(extent={{-110,-80},{-90,-60}})));
  .ThermofluidStream.Idealized.Boundaries.Sink_free sinkB2(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{-20,-60},{0,-40}})));
  ...
  .ThermofluidStream.Idealized.Boundaries.MassFlowRate massFlowRateA2(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{-50,-110},{-30,-90}})));
  .ThermofluidStream.Idealized.Boundaries.MassFlowRate massFlowRateB1(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{-50,-40},{-30,-60}})));

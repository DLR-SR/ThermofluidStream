...
model JunctionT1 "Example - JunctionT1 with different processes"
  ...
  .ThermofluidStream.Idealized.Boundaries.Sink_free sink(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{-40,48},{-20,68}})));
  ...
  .ThermofluidStream.Idealized.Boundaries.Sink_free sink1(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{180,50},{200,70}})));
  ...
  .ThermofluidStream.Idealized.Boundaries.Sink_free sink2(redeclare package Medium = Medium, considerInertance=false) annotation (Placement(transformation(extent={{-30,-70},{-10,-50}})));

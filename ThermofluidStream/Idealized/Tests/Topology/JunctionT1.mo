...
model JunctionT1 "Example - JunctionT1 with different processes"
  ...
  .ThermofluidStream.Idealized.Sources.Sink_free sink2(redeclare package Medium = Medium, neglectInertance=true) annotation(Placement(transformation(extent={{-30,-70},{-10,-50}})));

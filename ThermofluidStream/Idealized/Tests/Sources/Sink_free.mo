...
model Sink_free "Example - free sink"
  ...
  .ThermofluidStream.Idealized.Sources.MassFlowRate massFlowRate1(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{-170,50},{-150,70}})));
  .ThermofluidStream.Idealized.Sources.MassFlowRate massFlowRate2(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{-170,-30},{-150,-10}})));
  .ThermofluidStream.Idealized.Sources.MassFlowRate massFlowRate3(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{-170,-110},{-150,-90}})));
  .ThermofluidStream.Idealized.Sources.MassFlowRate massFlowRate4(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{-10,50},{10,70}})));
  .ThermofluidStream.Idealized.Sources.MassFlowRate massFlowRate5(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{-10,-30},{10,-10}})));
  .ThermofluidStream.Idealized.Sources.MassFlowRate massFlowRate6(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{-10,-110},{10,-90}})));
  .ThermofluidStream.Idealized.Sources.MassFlowRate massFlowRate7(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{150,50},{170,70}})));
  .ThermofluidStream.Idealized.Sources.MassFlowRate massFlowRate8(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{150,-30},{170,-10}})));
  .ThermofluidStream.Idealized.Sources.MassFlowRate massFlowRate9(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{150,-110},{170,-90}})));

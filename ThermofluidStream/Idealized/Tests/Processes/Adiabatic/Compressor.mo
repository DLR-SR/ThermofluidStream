...
model Compressor "Compressor model with different adiabatic models (isentropic, perfect gas,...)"
  ...
  inner ThermofluidStream.DropOfCommons dropOfCommons(displayInstanceNames=true, displayParameters=true) annotation(Placement(transformation(extent={{180,180},{200,200}})));
...
equation
  ...
  connect(fullMedium2.outlet, sink4.inlet) annotation(Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(idealGasConstantGamma.outletSpec_prescribed, pressureRatio.y) annotation (Line(points={{-70,28},{-70,-10},{-150,-10},{-150,10},{-159,10}}, color={0,0,127}));
  connect(fullMedium.outletSpec_prescribed, pressureRatio.y) annotation(Line(points={{-70,158},{-70,150},{-150,150},{-150,10},{-159,10}},
                                                                                                                                        color={0,0,127}));
  connect(fullMedium2.outletSpec_prescribed, pressureRatio.y) annotation(Line(points={{30,122},{30,130},{-150,130},{-150,10},{-159,10}},
                                                                                                                                       color={0,0,127}));
  ...
  connect(idealGasConstantGamma2.outlet, sink6.inlet) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(idealGasConstantGamma2.outletSpec_prescribed, pressureRatio.y) annotation (Line(points={{30,-18},{30,-10},{-150,-10},{-150,10},{-159,10}}, color={0,0,127}));
  ...
  connect(fullMedium2.P_in, gain.y) annotation(Line(points={{20,118},{20,140},{-19,140}},
                                                                                       color={255,170,85}));
  connect(idealGasConstantGamma1.P_in, gain1.y) annotation (Line(points={{20,32},{20,0},{-19,0}},
                                                                                                color={255,170,85}));
  connect(idealGasConstantGamma2.P_in, gain1.y) annotation (Line(points={{20,-22},{20,0},{-19,0}},
                                                                                                 color={255,170,85}));
  connect(idealGasConstantGamma.P_out, gain1.u) annotation (Line(points={{-80,33},{-80,0},{-42,0}}, color={255,170,85}));
  ...
  connect(perfetGas.outlet, sink2.inlet) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(perfetGas.outletSpec_prescribed, pressureRatio.y) annotation (Line(points={{-70,-102},{-70,-140},{-150,-140},{-150,10},{-159,10}}, color={0,0,127}));
  ...
  connect(perfetGas2.outlet, sink8.inlet) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(perfetGas2.outletSpec_prescribed, pressureRatio.y) annotation (Line(points={{30,-148},{30,-140},{-150,-140},{-150,10},{-159,10}}, color={0,0,127}));
  connect(perfetGas1.P_in, gain2.y) annotation (Line(points={{20,-98},{20,-130},{-19,-130}},
                                                                                           color={255,170,85}));
  connect(perfetGas2.P_in, gain2.y) annotation (Line(points={{20,-152},{20,-130},{-19,-130}},
                                                                                            color={255,170,85}));
  connect(perfetGas.P_out, gain2.u) annotation (Line(points={{-80,-97},{-80,-130},{-42,-130}}, color={255,170,85}));
  ...
  connect(idealGasConstantGamma3.outlet, sink10.inlet) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(idealGasConstantGamma3.P_in, gain1.y) annotation (Line(points={{120,32},{120,0},{-19,0}},
                                                                                                color={255,170,85}));

...
model MassFractionModifierError "Example - MassFractionModifier"
  ...
  ThermofluidStream.Idealized.Sink_m sink2(redeclare package Medium = Medium, m_flowSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{30,0},{50,20}})));

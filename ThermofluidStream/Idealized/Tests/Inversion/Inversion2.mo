...
model Inversion2 "Example - Inversion with temperature as iteration variable"
  ...
  Modelica.Blocks.Math.InverseBlockConstraints inverseBlockConstraints
    annotation(Placement(transformation(extent={{-40,-44},{0,-20}})));
...
equation
  connect(temperatureSetpoint.y, inverseBlockConstraints.u1)
    annotation(Line(points={{-59,-32},{-42,-32}}, color={0,0,127}));
  connect(singleSensorSelect.value_out, inverseBlockConstraints.u2)
    annotation(Line(points={{30,1.8},{30,-12},{-26,-12},{-26,-32},{-36,-32}}, color={0,0,127}));
  connect(inverseBlockConstraints.y2, sourceB.T0_var)
    annotation(Line(points={{-3,-32},{-6,-32},{-6,-8},{-84,-8},{-84,10},{-72,10}}, color={0,0,127}));
  annotation(

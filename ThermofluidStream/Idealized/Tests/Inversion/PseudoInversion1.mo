...
model PseudoInversion1 "Example - Pseudo-inversion using a feedback control loop"
  extends ThermofluidStream.Idealized.Tests.Inversion.BaseClasses.PartialInverse(massFlowRateB(m_flowSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed));
...
m_flow_A * T_A + m_flow_B * T_B = (m_flow_A + m_flow_B) * T_mix;
  ...
  <p>
    Instead of using a nonlinear equation solver (e.g., <code><a href=\"modelica://ThermoFluidStreamPlus.Idealized.Tests.Inversion.Inversion1\">Inversion1</a></code>), 
  ...
  <ul>
    <li>Start values can be more explicitly defined than with, for example, <code><a href=\"modelica://ThermoFluidStreamPlus.Idealized.Tests.Inversion.Inversion1\">Inversion1</a></code>.</li>

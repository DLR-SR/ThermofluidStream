...
model Step3RamAir
  ...
  Processes.Isobaric heatExchangerSideB(
    ...
    specifyOutlet=false) annotation (Placement(transformation(extent={{10,40},{-10,60}})));
  Processes.Adiabatic compressor(
    ...
    outletValueSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{-52,-10},{-32,10}})));

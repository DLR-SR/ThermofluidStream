...
equation
  ...
  annotation(
    ...
    Diagram(
      coordinateSystem(extent={{-180,-100},{180,100}}),
      graphics={
        Text(
          extent={{-132,6},{-126,0}},
  ...
  <p>
    ...
    The low pressure turbine drives the low pressure compressor and provides power.
  </p>
  ...
  <p>
    This setup creates one implicit nonlinear equation (the outlet pressure of <code>highPressureTurbine</code> has to be calculated from the mass flow rate and the power required for the highPressureCompressor).

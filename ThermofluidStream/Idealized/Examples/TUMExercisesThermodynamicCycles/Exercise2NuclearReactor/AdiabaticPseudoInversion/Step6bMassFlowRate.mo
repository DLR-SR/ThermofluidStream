...
equation
  ...
  connect(temperatureSensor.value_out, feedback.u2) annotation(Line(points={{41,30},{56,30},{56,52}},   color={0,0,127}));
  ...
  connect(feedback1.u2, temperatureSensor1.value_out) annotation(Line(points={{60,-28},{60,-48},{41,-48}},   color={0,0,127}));
  ...
  connect(feedback2.u2, temperatureSensor2.value_out) annotation(Line(points={{60,-120},{60,-134},{41,-134}},   color={0,0,127}));
  ...
  connect(temperatureSensor3.value_out, feedback4.u2) annotation(Line(points={{191,100},{260,100},{260,48}},   color={0,0,127}));

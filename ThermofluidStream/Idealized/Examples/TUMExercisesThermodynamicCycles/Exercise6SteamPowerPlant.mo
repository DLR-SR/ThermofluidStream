...
model Exercise6SteamPowerPlant "Exercise 8.6: Steam Power Plant [TUM2019]"
  ...
  ThermofluidStream.Idealized.EnergyFlow.Sources.FixedEnergyFlow heatFlow(E_flow(displayUnit="MW") = 288000000) annotation (Placement(transformation(extent={{-112,10},{-92,30}})));
equation

...
equation
  ...
  connect(gasExchange.outlet, loopBreaker.inlet)annotation(
    Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(expansion.P_out, shaftPower.E_flow_in[1]) annotation(Line(points={{20,3},{20,-21.5},{80,-21.5}},   color={255,170,85}));
  connect(compression.P_out, shaftPower.E_flow_in[2]) annotation(Line(points={{-60,3},{-60,-18},{80,-18},{80,-18.5}},
                                                                                                                  color={255,170,85}));

...
model Separator "Model of a phase separator for two-phase medium - Overdetermined (1 equation)"
  ...
  ThermofluidStream.Idealized.Processes.Isobaric isobaricHeatFlowPort(
    ...
    outletValueSpec=ThermofluidStream.Idealized.Utilities.Types.ValueSpecification.Prescribed) annotation (Placement(transformation(extent={{10,-50},{-10,-70}})));
...
equation
  ...
  <p>
    ...
    (e.g., <a href=\"modelica://ThermoFluidStreamPlus.Idealized.Sources.LoopBreaker\">LoopBreaker</a> or 

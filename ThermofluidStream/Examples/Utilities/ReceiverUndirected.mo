...
<p><br>The only difference to the directed <a href=\"ThermofluidStream.Examples.Utilities.Receiver\">Receiver</a> model is, that it has outlet pipes on <strong>both</strong> sides of the volume. Hence the liquid phase is extracted from the respective pipe, depending on the flow direction.</p>

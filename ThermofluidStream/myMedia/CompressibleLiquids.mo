...
package CompressibleLiquids "Compressible liquid models"
  ...
  package Common "Base classes for compressible liquids"
    ...
    partial package LinearWater_pT
      ...
      extends myMedia.Interfaces.PartialLinearFluid(
        ...
        beta_const=myMedia.Water.StandardWater.isobaricExpansionCoefficient(
            state),
      ...
      constant myMedia.Water.StandardWater.ThermodynamicState state=
          myMedia.Water.StandardWater.setState_pT(reference_p, reference_T);
    end LinearWater_pT;
  end Common;
  ...
  package LinearWater_pT_Ambient
    ...
    extends myMedia.CompressibleLiquids.Common.LinearWater_pT(reference_p=
          101325, reference_T=298.15);
  redeclare function extends dynamicViscosity "Dynamic viscosity of water"
  algorithm
    eta := 8.9e-4;
  end dynamicViscosity;

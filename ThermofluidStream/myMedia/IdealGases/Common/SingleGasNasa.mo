...
"); MM = data.MM;
  ...
  redeclare function extends specificEntropy "Return specific entropy"
    extends Modelica.Icons.Function;
  algorithm
    s := myMedia.IdealGases.Common.Functions.s0_T(data, state.T) - data.R*
      Modelica.Math.log(state.p/reference_p);
    annotation(Inline=true,smoothOrder=2);
  end specificEntropy;
  ...
  redeclare function extends specificGibbsEnergy "Return specific Gibbs energy"
    extends Modelica.Icons.Function;
  algorithm
    g := myMedia.IdealGases.Common.Functions.h_T(data, state.T) - state.T*
  ...
  redeclare function extends specificHelmholtzEnergy
    ...
    extends Modelica.Icons.Function;
  algorithm
    f := myMedia.IdealGases.Common.Functions.h_T(data, state.T) - data.R*state.T
  ...
  redeclare function extends velocityOfSound "Return velocity of sound"
    extends Modelica.Icons.Function;
  algorithm
    a := sqrt(max(0, data.R*state.T*myMedia.IdealGases.Common.Functions.cp_T(
  ...
  package Internal
    ...
    redeclare function extends f_nonlinear
    algorithm
        y := myMedia.IdealGases.Common.Functions.s0_T(f_nonlinear_data, x) -
          data.R*Modelica.Math.log(p/reference_p);
    end f_nonlinear;
...
// the functions below are not strictly necessary, there are just here for compatibility reasons
  ...
  function dynamicViscosityLowPressure
    ...
    input myMedia.Interfaces.Types.DipoleMoment mu
      "Dipole moment of gas molecule";
    input Real k =  0.0 "Special correction for highly polar substances";
    output myMedia.Interfaces.Types.DynamicViscosity eta
...
<p>T. Skoglund, Lund, Sweden, 2004-08-31</p>
  ...
  function thermalConductivityEstimate
    ...
    extends Modelica.Icons.Function;
    input myMedia.Interfaces.Types.SpecificHeatCapacity Cp
      "Constant pressure heat capacity";
    input myMedia.Interfaces.Types.DynamicViscosity eta "Dynamic viscosity";
    input Integer method(min=1,max=2)=1
      "1: Eucken Method, 2: Modified Eucken Method";
    input IdealGases.Common.DataRecord data "Ideal gas data";
    output myMedia.Interfaces.Types.ThermalConductivity lambda

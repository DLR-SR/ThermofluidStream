...
model MultiSensor_Tpm1small "v1.2 of MultiSensor_Tpm"
  ...
  Interfaces.Inlet inlet(redeclare package Medium=Medium)
    annotation (Placement(transformation(extent={{-80,-120},{-40,-80}}), iconTransformation(extent={{-80,-120},{-40,-80}})));
  Interfaces.Outlet outlet(redeclare package Medium=Medium)
    annotation (Placement(transformation(extent={{42,-120},{82,-80}}), iconTransformation(extent={{42,-120},{82,-80}})));

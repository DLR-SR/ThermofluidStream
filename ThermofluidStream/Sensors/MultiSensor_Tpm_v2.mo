...
model MultiSensor_Tpm_v2 "Version 2 of MultiSensor_Tpm"
  ...
  Modelica.Blocks.Interfaces.RealOutput T_out(final quantity="ThermodynamicTemperature", final unit=temperatureUnit) = T if outputTemperature "Temperature output conenctor"

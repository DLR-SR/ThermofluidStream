...
model SingleFlowSensor "Flow rate sensor"
  ...
  final parameter String quantityString=
    ...
    elseif quantity == ThermofluidStream.Sensors.Internal.Types.MassFlowQuantities.S_flow_kJpKs then "S_flow in kW/K"
    elseif quantity == ThermofluidStream.Sensors.Internal.Types.MassFlowQuantities.S_flow_MJpKs then "S_flow in MW/K"

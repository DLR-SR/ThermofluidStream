...
equation
  ...
  annotation (
    defaultComponentName = "sudden_contraction",
    Documentation(info="<html><head></head><body><p>This component models a <b>sudden pipe contraction</b>. It<span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">&nbsp;computes the pressure loss of the fluid depending on the massflow rate or the massflow rate depending on a given pressure difference, some medium properties and the geometry of the contraction. The model is valid for&nbsp;</span><strong style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">both incompressible and compressible calculation</strong><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">&nbsp;up to at least Ma 0.3 at pipe outlet and&nbsp;</span><strong style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">one phase medium.</strong></p><p><font face=\"MS Shell Dlg 2\">The pressure loss is calculated with the <b>same functions used in the sudden expansion</b> model.&nbsp;To obtain an<b> inverse effect, the function is subjected to a virtual negative mass flow</b>. The negative mass flow is compensated by a change of sign in the pressure drop. The <b>mass flow through the base model is not affected</b> by this.</font></p><p>The pipe bend component is using the partial model <a href=\"modelica://Fluid_HTWG.Interfaces.SISOFlow_nonConstArea\">SISOFlow_nonConstArea</a> implementing the common flow balances.  For the calculation of pressure loss the function <a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.Orifice.dp_suddenChange_DP\">dp_suddenChange_DP</a> by Modelica is implemented. The input records <a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.Orifice.dp_suddenChange_IN_con\">dp_suddenChange_IN_con</a> &amp; <a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.Orifice.dp_suddenChange_IN_var\">dp_suddenChange_IN_var</a> are overwritten with the input parameters defining the geometry of the expansion and fluid properties. For more information on the underlying pressure loss function, <a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.Orifice.dp_suddenChange\">click here</a>. To improve the accuracy when compressible media are used, center state fluid properties (mean dynamic viscosity &amp; mean density) are defined and refered to in the pressure loss function.</p><p>The following figure, a resistance coefficient chart representing the pressure loss model under common conditions is shown.
      
      <table border=\"0\" cellspacing=\"0\" cellpadding=\"2\">
      <caption align=\"bottom\"><strong>Fig. 1:</strong> Resistance coefficient ζ vs. cross section ratio A_1/A_2</caption>
      <tbody><tr>
      <td>
        <img src=\"modelica://Fluid_HTWG/Resources/Images/Fluid/Pipes/SuddenContraction/suddenContraction.png\" alt=\"Resistance coefficient ζ vs. cross section ratio A_1/A_2\" width=\"500\" height=\"375\">
      </td>
      </tr>
      </tbody></table>

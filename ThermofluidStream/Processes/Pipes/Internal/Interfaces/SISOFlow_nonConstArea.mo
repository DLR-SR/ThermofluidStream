...
equation
  ...
  annotation (
    Documentation(info="<html><head></head><body><p> <a href=\"modelica://ThermofluidStream.Interfaces.SISOFlow\">SISOFlow</a> from ThermofluidStream extended to&nbsp;<b>restore Bernoulli's principle</b>&nbsp;(change of static pressure due to change of velocity), i.e. diffusors (different crosssectional area of inlet and outlet) .</p><p><font face=\"Courier New\">p_out = p_in&nbsp;+ dq + dp</font></p><p><font face=\"MS Shell Dgl 2\">Change of static pressure due to change of velocity dq:</font></p><p><sub><font size=\"3\"><span style=\"font-family: 'Courier New';\">dq = rho/2 * (c_in^2 - c_out^2)</span></font></sub></p><p><sub><font size=\"3\"><span style=\"font-family: 'Courier New';\"><br></span></font></sub></p><p><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">&nbsp;&nbsp;</span><em>[P. Jordan; HTWG Konstanz; 01/24]</em><p></p><p>

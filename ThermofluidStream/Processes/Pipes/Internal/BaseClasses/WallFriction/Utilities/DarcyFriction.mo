...
algorithm
  ...
  lambda := lambda2/Re^2;
  annotation (
    Documentation(info = "<html><head></head><body>Function calculating Darcy friction factor lambda as f(m_flow, D_h, Delta, rho, mu, Re1, Re2), where:<div><ul><li>m_flow: <span class=\"Apple-tab-span\" style=\"white-space:pre\">        </span>mass flow rate [kg/s]</li><li>D_h: <span class=\"Apple-tab-span\" style=\"white-space:pre\">        </span>hydraulic diameter [m]</li><li>Delta: <span class=\"Apple-tab-span\" style=\"white-space:pre\">        </span>relative roughness [m/m]</li><li>rho:<span class=\"Apple-tab-span\" style=\"white-space:pre\">                </span>density [kg/m^3]</li><li>mu: <span class=\"Apple-tab-span\" style=\"white-space:pre\">                </span>dynamic viscosity [Pa.s]</li><li>Re1:<span class=\"Apple-tab-span\" style=\"white-space:pre\">                </span>lower Reynolds Number boundary for laminar-turbulent transition flow regime [-]</li><li>Re2:<span class=\"Apple-tab-span\" style=\"white-space:pre\">                </span>upper Reynolds Number boundary for laminar-turbulent transition flow regime [-]</li></ul>The function is extracted from <a href=\"modelica://Modelica.Fluid.Pipes.BaseClasses.WallFriction.Detailed.Internal.dp_fric_of_m_flow\">dp_fric_of_m_flow</a>.</div><div><br></div><div><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">&nbsp;&nbsp;</span><em style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">[P. Jordan; HTWG Konstanz; 12/23]</em></div></body></html>"));
end DarcyFriction;

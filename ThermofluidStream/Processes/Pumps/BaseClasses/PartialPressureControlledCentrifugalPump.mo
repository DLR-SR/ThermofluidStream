...
partial model PartialPressureControlledCentrifugalPump "Base model of pressure controlled centrifugal pump"
...
protected
  ...
  Real tau_r = tau/tau_ref "Torque ratio";
...
equation
  ...
  annotation (Icon(graphics={
        ...
        Line(
          ...
          color={28,108,200},
          thickness=0.5)}));
end PartialPressureControlledCentrifugalPump;

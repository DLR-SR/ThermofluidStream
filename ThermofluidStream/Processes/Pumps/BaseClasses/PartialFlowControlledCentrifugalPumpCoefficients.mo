...
partial model PartialFlowControlledCentrifugalPumpCoefficients
  "Base model of flow controlled centrifugal pump based on 3+1+2 coefficients for head, power and efficiency"
...
end PartialFlowControlledCentrifugalPumpCoefficients;

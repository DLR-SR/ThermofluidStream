...
partial model PartialPressureControlledCentrifugalPumpEfficiency "Base model of pressure controlled centrifugal pump based on 3+1+2 coefficients for head, power and efficiency"
...
end PartialPressureControlledCentrifugalPumpEfficiency;

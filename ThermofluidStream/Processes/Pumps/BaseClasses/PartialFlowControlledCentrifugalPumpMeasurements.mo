...
partial model PartialFlowControlledCentrifugalPumpMeasurements "Base model of flow controlled centrifugal pump based on measurements at reference speed"
...
end PartialFlowControlledCentrifugalPumpMeasurements;

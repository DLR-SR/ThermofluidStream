...
partial model PartialCentrifugalPumpMeasurements "Base model of centrifugal pump based on measurements at reference speed (either speed controlled and flange)"
...
end PartialCentrifugalPumpMeasurements;

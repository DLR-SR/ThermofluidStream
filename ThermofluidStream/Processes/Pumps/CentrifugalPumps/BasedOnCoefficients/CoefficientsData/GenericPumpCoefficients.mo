...
record GenericPumpCoefficients "Generic pump coefficient record"
  ...
  parameter SI.AngularVelocity  w_ref(displayUnit="rpm") "Reference angular velocity";
  ...
  parameter SI.VolumeFlowRate V_flow_ref  "Reference volume flow rate at zero head"

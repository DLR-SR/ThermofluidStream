...
model SpeedControlledCentrifugalPumpCoefficients
  "Ideal controlled (angular velocity) centrifugal pump based on 3+1+2 coefficients for head, power and efficiency"
  ...
  parameter SI.AngularVelocity w_par = coefficients.w_ref "Constant angular velocity"
...
end SpeedControlledCentrifugalPumpCoefficients;

...
model Test_PressureSourceIncompressibleFluid
  ...
  Sources.IncompressibleFluid.PressureSourceIncompressibleFluid pressureControlledSimplePump(
...
end Test_PressureSourceIncompressibleFluid;

...
<p><span style=\"font-size: 12pt;\">Pressure loss function without actual equations with an always failing assert to output a meaningful error, when the user forgot to select a function. This should be used as a default. </span></p>
</html>"));

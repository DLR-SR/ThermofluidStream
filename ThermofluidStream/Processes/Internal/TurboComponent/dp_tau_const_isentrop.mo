...
<ol>
<li>with the scaling factors <span style=\"font-family: Courier New;\">omega_ref, m_flow_ref </span>and the scewness factor<span style=\"font-family: Courier New;\"> skew, </span>the pressure ratio<span style=\"font-family: Courier New;\"> pr=p_outlet/p_inlet </span>is computed as quadratic function of<span style=\"font-family: Courier New;\"> omega/omega_ref, m_flow/m_flow_ref: </span></li>
...
<p><span style=\"font-family: Courier New;\">omega_ref</span> and <span style=\"font-family: Courier New;\">m_flow_ref</span> are supposed to be scaling factors for omega and m_flow respectiveley. <span style=\"font-family: Courier New;\">omega_ref</span> is the angular velocity that produces a pressure ratio of 2 at m_flow=0. <span style=\"font-family: Courier New;\">m_flow_ref</span> is the massflow, that produces a negative pressure ratio of 1 at <span style=\"font-family: Courier New;\">omega=omega_ref</span>. The skewness factor can be used to shape the characteristic curve inbetween (see fig. 1).</p>

...
model FlowSourceIdealGas
  ...
  extends ThermofluidStream.Processes.Compressors.BaseClasses.PartialFlowSourceIdealGas;

  import SetpointMode = ThermofluidStream.Processes.Compressors.Internal.Types.CompressorSetpointModeFlow;

  parameter SetpointMode setpoint=ThermofluidStream.Processes.Compressors.Internal.Types.CompressorSetpointModeFlow.m_flow "Compressor setpoint (m_flow or V_flow)"

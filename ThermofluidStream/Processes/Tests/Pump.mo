...
Medium model for the test. Should be incompressible or with low compressibility.
  ...
  tf.Processes.Tests.Power power1(P=8000, tau_max=150) annotation (Placement(transformation(extent={{-24,2},{-4,22}})));
  ...
  tf.Processes.Tests.Power power2(P=5000, tau_max=150) annotation (Placement(transformation(extent={{-24,-78},{-4,-58}})));

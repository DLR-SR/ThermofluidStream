...
type PressureUnit = enumeration(
  Pa  "Pa",
  kPa "kPa",
  bar "bar") "Display the pressure in different units (Pa, kPa, bar)"
annotation (choices(__Dymola_radioButtons=true,
  choice=ThermofluidStream.Types.PressureUnit.Pa "Pa",
  choice=ThermofluidStream.Types.PressureUnit.kPa "kPa",
  choice=ThermofluidStream.Types.PressureUnit.bar "bar"),Documentation(revisions="<html>
<ul>
<li>

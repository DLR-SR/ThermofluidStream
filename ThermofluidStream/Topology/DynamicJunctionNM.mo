...
<p>Dynamic multiport <b>N-to-M</b> junction for transient manifold behavior. Use this model in complex distribution/collection nodes where dynamic pressure effects are important. </p>

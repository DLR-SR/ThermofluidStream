...
<li>It defines <b>global assertion and error handling</b> behavior via the <code>assertionLevel</code> parameter.</li>
<li>It provides <b>layout and visualization settings</b> for model diagrams, such as displaying instance names, parameter values, and visualization (in color) for e.g. resistance pressure drop.</li>
</ul>
...
<p style=\"margin-left: 40px;\"><code><b>inner</b></code> ThermofluidStream.DropOfCommons dropOfCommons </p>

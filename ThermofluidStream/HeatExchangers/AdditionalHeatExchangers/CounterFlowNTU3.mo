...
model CounterFlowNTU3 "Counter flow heat exchanger using the epsilon-NTU method"
...
equation
  inletA = inletA_internal;
  inletB = inletB_internal;
  outletA = outletA_internal;
  outletB = outletB_internal;

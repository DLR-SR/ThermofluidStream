...
package Tests "Test Package for the Media Packages"
  ...
  model TestXRGMedia "Test for five XRG Media with various components"
    ...
    Processes.FlowResistance flowResistance8(
      ...
      annotation (Placement(transformation(
          ...
          origin={86,32})));
  equation
    connect(discretizedHEX.inletRef, discretizedHEX1.outletAir)
      annotation (Line(
        points={{-8,64},{19.8,64}},
        color={28,108,200},
        thickness=0.5));
    connect(source.outlet, discretizedHEX.inletAir) annotation (Line(
        points={{-54,80},{-28,80}},
        color={28,108,200},
        thickness=0.5));
    connect(sink1.inlet, discretizedHEX.outletRef) annotation (Line(
        points={{-38,64},{-28.2,64}},
        color={28,108,200},
        thickness=0.5));
    connect(discretizedHEX1.inletRef, volumeFlex.outlet) annotation (Line(
        points={{20,48},{16,48}},
        color={28,108,200},
        thickness=0.5));
    connect(discretizedHEX2.outletAir, volumeFlex.inlet)
      annotation (Line(
        points={{-7.8,48},{-4,48}},
        color={28,108,200},
        thickness=0.5));
    connect(receiver.inlet, discretizedHEX2.outletRef)
      annotation (Line(
    ...
    connect(volume.outlet, flowResistance1.inlet) annotation (Line(
        ...
        color={28,108,200},
        thickness=0.5));
    connect(flowResistance1.outlet, discretizedHEX1.inletAir)
      annotation (Line(
        points={{52,64},{40,64}},
        color={28,108,200},
        thickness=0.5));
    connect(source1.outlet, flowResistance2.inlet) annotation (Line(
        ...
        color={28,108,200},
        thickness=0.5));
    connect(flowResistance2.outlet, discretizedHEX2.inletAir)
      annotation (Line(
        points={{-40,48},{-28,48}},
        color={28,108,200},
        thickness=0.5));
    ...
    connect(flowResistance4.outlet, conductionElement.inlet)
      annotation (Line(
        ...
        color={28,108,200},
        thickness=0.5));
    connect(conductionElement.outlet, discretizedHEX4.inletRef)
      annotation (Line(
        points={{24,0},{-24,0}},
        color={28,108,200},
        thickness=0.5));
    connect(flowResistance5.outlet, junctionT2_1.inletA)
      annotation (Line(
        ...
        color={28,108,200},
        thickness=0.5));
    connect(discretizedHEX4.outletRef, junctionT2_1.inletB)
      annotation (Line(
        points={{-44.2,0},{-122,0}},
        color={28,108,200},
        thickness=0.5));
    connect(junctionT2_1.outlet, sink3.inlet) annotation (Line(
        ...
        color={28,108,200},
        thickness=0.5));
    connect(discretizedHEX4.outletAir, nozzle.inlet) annotation (Line(
        points={{-23.8,16},{-14,16}},
        color={28,108,200},
        thickness=0.5));
    connect(discretizedHEX.outletAir, splitterT2_1.inlet)
      annotation (Line(
    ...
    connect(splitterT2_1.outletB, flowResistance4.inlet)
      annotation (Line(
        ...
        color={28,108,200},
        thickness=0.5));
    connect(discretizedHEX1.outletRef, flowResistance3.inlet)
      annotation (Line(
        points={{40.2,48},{58,48}},
        color={28,108,200},
        thickness=0.5));
    ...
    connect(sink.inlet, flowResistance6.outlet) annotation (Line(
        ...
        color={28,108,200},
        thickness=0.5));
    connect(dynamicPressureInflow.outlet, discretizedHEX4.inletAir)
      annotation (Line(
        points={{-54,16},{-44,16}},
        color={28,108,200},
        thickness=0.5));
    ...
    connect(splitterT2_1.outletA, flowResistance8.inlet) annotation (Line(
        ...
        color={28,108,200},
        thickness=0.5));
    connect(discretizedHEX2.inletRef, counterFlowNTU.outletB)
      annotation (Line(
    ...
    connect(counterFlowNTU.outletA, dynamicPressureOutflow.inlet)
      annotation (Line(
        ...
        color={28,108,200},
        thickness=0.5));
    annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-180,-100},{160,100}})), Diagram(coordinateSystem(preserveAspectRatio=false,

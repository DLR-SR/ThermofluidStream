...
model TestLiqLoopJP8 "Test of medium JP8 for a liquid loop"
  ...
  replaceable package TertiaryMedium = ThermofluidStream.Media.additionalMedia.Incompressible.JP8 constrainedby
    ThermofluidStream.Media.myMedia.Interfaces.PartialMedium annotation (choicesAllMatching=true);
...
equation
  ...
  <p>
    <code>TestLiqLoopJP8</code> is a Modelica test model for <a href=\"modelica://ThermofluidStream.Media.additionalMedia.Incompressible.JP8\">JP8</a>, a jet propulsion fuel often used in military aircraft.
    It simulates a liquid loop system with a primary JP8 circuit and a secondary CO2 circuit.
  </p>
  <p>
    The primary loop includes a reservoir, centrifugal pump, flow resistances, and heating element.
    A 40 kW heating element adds thermal energy to the JP8 fluid. The pump maintained a temperature difference of 15°C across the conduction element.
  </p>
  <p>

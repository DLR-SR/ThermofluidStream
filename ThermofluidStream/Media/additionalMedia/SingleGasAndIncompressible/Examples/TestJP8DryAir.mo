...
model TestJP8DryAir "Test JP8DryAir Medium model"
  ...
  package Medium = ThermofluidStream.Media.additionalMedia.SingleGasAndIncompressible.JP8DryAir "Jet fuel medium model";
...
equation
  ...
  state2 = Medium.setState_phX(
    medium.p,
    medium.h,
    medium.X);

  annotation (experiment(StopTime=159, __Dymola_Algorithm="Dassl"), Documentation(info="<html>
<p>Density</p>

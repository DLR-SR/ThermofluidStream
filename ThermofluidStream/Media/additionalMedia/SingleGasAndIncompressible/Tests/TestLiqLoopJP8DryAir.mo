...
equation
  ...
  <p>
    <code>TestLiqLoopJP8DryAir</code> is a Modelica test model for <a href=\"modelica://ThermofluidStream.Media.additionalMedia.SingleGasAndIncompressible.JP8DryAir\">JP8DryAir</a>, a mixture of JP8, a jet propulsion fuel often used in military aircraft, and dry air.
    It simulates a liquid loop system with a primary JP8 and dry air circuit and a secondary CO2 circuit.
  </p>
  <p>
    The primary loop includes a reservoir, centrifugal pump, flow resistances, and heating element.
    A 40 kW heating element adds thermal energy to the JP8 and dry air fluid. The pump maintained a temperature difference of 15°C across the conduction element.
  </p>
  <p>

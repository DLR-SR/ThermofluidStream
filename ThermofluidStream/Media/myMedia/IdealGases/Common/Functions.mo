...
package Functions
  ...
  constant ThermofluidStream.Media.myMedia.Interfaces.Choices.ReferenceEnthalpy
    referenceChoice=ThermofluidStream.Media.myMedia.Interfaces.Choices.ReferenceEnthalpy.ZeroAt0K
    "Choice of reference enthalpy";
  constant ThermofluidStream.Media.myMedia.Interfaces.Types.SpecificEnthalpy h_offset=0.0
  ...
  algorithm
    h_der := dT*
      ThermofluidStream.Media.myMedia.IdealGases.Common.Functions.cp_T(data, T);
  ...
  algorithm
    h_der := dT*
      ThermofluidStream.Media.myMedia.IdealGases.Common.Functions.cp_Tlow(data,
      T);
    annotation(Inline=true,smoothOrder=2);
  end h_Tlow_der;

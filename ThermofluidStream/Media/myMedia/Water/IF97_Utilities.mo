  ...
  <li>Revised and extended for inclusion in Modelica.Thermal: December 2002</li>
    ...
    package Basic "Base functions as described in IAWPS/IF97"
      ...
      function g1 "Gibbs function for region 1: g(p,T)"
        ...
        input SI.Pressure p "Pressure";
        input SI.Temperature T "Temperature (K)";
        output ThermofluidStream.Media.myMedia.Common.GibbsDerivs g
      ...
      function f3 "Helmholtz function for region 3: f(d,T)"
        ...
        input SI.Density d "Density";
        input SI.Temperature T "Temperature (K)";
        output ThermofluidStream.Media.myMedia.Common.HelmholtzDerivs f
      ...
      protected
        ThermofluidStream.Media.myMedia.Common.GibbsDerivs gibbs
          "Dimensionless Gibbs function and derivatives w.r.t. pi and tau";
      algorithm
    ...
    package Transport "Transport properties for water according to IAPWS/IF97"
      ...
      protected
        ...
        ThermofluidStream.Media.myMedia.Common.GibbsDerivs g
          "Dimensionless Gibbs function and derivatives w.r.t. pi and tau";
        ThermofluidStream.Media.myMedia.Common.HelmholtzDerivs f
          "Dimensionless Helmholtz function and derivatives w.r.t. delta and tau";
        Real Tc=T - 273.15 "Celsius temperature for region check";
  ...
  <li>Documentation added: December 2002</li>
    ...
    package Inverses "Efficient inverses for selected pairs of variables"
      ...
      protected
        ...
        ThermofluidStream.Media.myMedia.Common.HelmholtzDerivs f
          "Dimensionless Helmholtz function and derivatives w.r.t. delta and tau";
        ThermofluidStream.Media.myMedia.Common.NewtonDerivatives_pT nDerivs
      ...
      protected
        ...
        ThermofluidStream.Media.myMedia.Common.HelmholtzDerivs f
          "Dimensionless Helmholtz function and derivatives w.r.t. delta and tau";
        ThermofluidStream.Media.myMedia.Common.NewtonDerivatives_ph nDerivs
          "Derivatives needed in Newton iteration";
        Boolean found=false "Flag for iteration success";
      ...
      protected
        ...
        ThermofluidStream.Media.myMedia.Common.HelmholtzDerivs f
          "Dimensionless Helmholtz function and derivatives w.r.t. delta and tau";
        ThermofluidStream.Media.myMedia.Common.NewtonDerivatives_ps nDerivs
          "Derivatives needed in Newton iteration";
      ...
      algorithm
        ...
        while ((i < IterationData.IMAX) and not found) loop
          f := Basic.f3(d, T);
          nDerivs := ThermofluidStream.Media.myMedia.Common.Helmholtz_ps(f);
          ds := nDerivs.s - s;
          dp := nDerivs.p - p;
  ...
  <li>Documentation added: December 2002</li>
    ...
    package ByRegion "Simple explicit functions for one region only"
      ...
      function waterR1_pT "Standard properties for region 1, (p,T) as inputs"
        ...
        input SI.Temperature T "Temperature (K)";
        output
          ThermofluidStream.Media.myMedia.Common.ThermoFluidSpecial.ThermoProperties_pT
      ...
      algorithm
        g := Basic.g1(p, T);
        pro :=
          ThermofluidStream.Media.myMedia.Common.ThermoFluidSpecial.gibbsToProps_pT(
          g);
      end waterR1_pT;
      ...
      algorithm
        f := Basic.f3(d, T);
        pro :=
          ThermofluidStream.Media.myMedia.Common.ThermoFluidSpecial.helmholtzToProps_dT(
          f);
  ...
  <li>Documented and re-organized: January 2003</li>
    ...
    package TwoPhase
      ...
      function waterLiq_p "Properties on the liquid phase boundary of region 4"
        ...
        extends Modelica.Icons.Function;
        input SI.Pressure p "Pressure";
        output ThermofluidStream.Media.myMedia.Common.PhaseBoundaryProperties liq
      ...
      algorithm
        ...
        if p < data.PLIMIT4A then
          g := Basic.g1(p, Tsat);
          liq := ThermofluidStream.Media.myMedia.Common.gibbsToBoundaryProps(g);
        else
          dl := Regions.rhol_p_R4b(p);
          f := Basic.f3(dl, Tsat);
          liq :=
            ThermofluidStream.Media.myMedia.Common.helmholtzToBoundaryProps(f);
        end if;
      end waterLiq_p;
      ...
      function waterVap_p "Properties on the vapour phase boundary of region 4"
        ...
        extends Modelica.Icons.Function;
        input SI.Pressure p "Pressure";
        output ThermofluidStream.Media.myMedia.Common.PhaseBoundaryProperties vap
      ...
      algorithm
        ...
        if p < data.PLIMIT4A then
          g := Basic.g2(p, Tsat);
          vap := ThermofluidStream.Media.myMedia.Common.gibbsToBoundaryProps(g);
        else
      ...
      function waterSat_ph
        ...
        input SI.Pressure p "Pressure";
        input SI.SpecificEnthalpy h "Specific enthalpy";
        output ThermofluidStream.Media.myMedia.Common.SaturationProperties pro
          "Thermodynamic property collection";
      protected
        SI.Density dl "Liquid density";
        SI.Density dv "Vapour density";
        ThermofluidStream.Media.myMedia.Common.GibbsDerivs gl
          "Dimensionless Gibbs function and derivatives w.r.t. pi and tau";
        ThermofluidStream.Media.myMedia.Common.GibbsDerivs gv
          "Dimensionless Gibbs function and derivatives w.r.t. pi and tau";
        ThermofluidStream.Media.myMedia.Common.HelmholtzDerivs fl
          "Dimensionless Helmholtz function and derivatives w.r.t. delta and tau";
        ThermofluidStream.Media.myMedia.Common.HelmholtzDerivs fv
          "Dimensionless Helmholtz function and derivatives w.r.t. delta and tau";
      algorithm
        pro.h := h;
        pro.p := p;
        ...
        if p < data.PLIMIT4A then
          ...
          gv := Basic.g2(p, pro.T);
          pro.liq :=
            ThermofluidStream.Media.myMedia.Common.gibbsToBoundaryProps(gl);
          pro.vap :=
            ThermofluidStream.Media.myMedia.Common.gibbsToBoundaryProps(gv);
        else
          dl := Regions.rhol_p_R4b(p);
          dv := Regions.rhov_p_R4b(p);
          ...
          pro.liq :=
            ThermofluidStream.Media.myMedia.Common.helmholtzToBoundaryProps(fl);
          pro.vap :=
            ThermofluidStream.Media.myMedia.Common.helmholtzToBoundaryProps(fv);
        end if;
        ...
        pro.cv := ThermofluidStream.Media.myMedia.Common.cv2Phase(
                pro.liq,
                pro.vap,
                pro.x,
                pro.T,
      ...
      function waterR4_ph
        ...
        input SI.SpecificEnthalpy h "Specific enthalpy";
        output
          ThermofluidStream.Media.myMedia.Common.ThermoFluidSpecial.ThermoProperties_ph
          pro "Thermodynamic property collection";
      protected
        SI.Density dl "Liquid density";
        SI.Density dv "Vapour density";
        ThermofluidStream.Media.myMedia.Common.PhaseBoundaryProperties liq
          "Phase boundary property record";
        ThermofluidStream.Media.myMedia.Common.PhaseBoundaryProperties vap
          "Phase boundary property record";
        ThermofluidStream.Media.myMedia.Common.GibbsDerivs gl
          "Dimensionless Gibbs function and derivatives w.r.t. pi and tau";
        ThermofluidStream.Media.myMedia.Common.GibbsDerivs gv
      ...
      algorithm
        ...
        if p < data.PLIMIT4A then
          gl := Basic.g1(p, pro.T);
          gv := Basic.g2(p, pro.T);
          liq := ThermofluidStream.Media.myMedia.Common.gibbsToBoundaryProps(gl);
          vap := ThermofluidStream.Media.myMedia.Common.gibbsToBoundaryProps(gv);
        else
          fl := Basic.f3(dl, pro.T);
          fv := Basic.f3(dv, pro.T);
          liq :=
      ...
      function waterR4_dT "Water properties in region 4 as function of d and T"
        ...
        input SI.Temperature T "Temperature";
        output
          ThermofluidStream.Media.myMedia.Common.ThermoFluidSpecial.ThermoProperties_dT
          pro "Thermodynamic property collection";
      protected
        SI.Density dl "Liquid density";
        SI.Density dv "Vapour density";
...
<ul>
  ...
  <li>Documented and re-organized: January 2003</li>
    ...
    function extraDerivs_ph
      ...
      input Integer phase=0
        "Phase: 2 for two-phase, 1 for one phase, 0 if unknown";
      output ThermofluidStream.Media.myMedia.Common.ExtraDerivatives dpro
        "Thermodynamic property collection";
    protected
      SI.Density d "Density";
      SI.Temperature T "Temperature";
    ...
    algorithm
      ...
      if region == 1 then
        T := Basic.tph1(p, h);
        g := Basic.g1(p, T);
        dpro := ThermofluidStream.Media.myMedia.Common.gibbsToExtraDerivs(g);
      elseif region == 2 then
        T := Basic.tph2(p, h);
        g := Basic.g2(p, T);
        dpro := ThermofluidStream.Media.myMedia.Common.gibbsToExtraDerivs(g);
      elseif region == 3 then
        (d,T,error) := Inverses.dtofph3(
              ...
              delh=1.0e-6);
        f := Basic.f3(d, T);
        dpro := ThermofluidStream.Media.myMedia.Common.helmholtzToExtraDerivs(f);
      elseif region == 5 then
...
<li>Function <strong>boundaryderivs_p</strong> is the Modelica derivative function of <strong>boundaryvals_p</strong>
</li>
  ...
  package ThermoFluidSpecial
    ...
    algorithm
      ...
      if (region == 1) then
        ...
        g := BaseIF97.Basic.g1(p, T);
        pro :=
          ThermofluidStream.Media.myMedia.Common.ThermoFluidSpecial.gibbsToProps_ph(
          g);
      elseif (region == 2) then
      ...
      elseif (region == 3) then
        ...
        pro :=
          ThermofluidStream.Media.myMedia.Common.ThermoFluidSpecial.helmholtzToProps_ph(
          f);
      elseif (region == 4) then
    ...
    algorithm
      ...
      if (region == 1) then
        ...
        g := BaseIF97.Basic.g1(p, T);
        pro :=
          ThermofluidStream.Media.myMedia.Common.ThermoFluidSpecial.gibbsToProps_dT(
          g);
      elseif (region == 2) then
        (p,error) := BaseIF97.Inverses.pofdt125(
              d=d,
    ...
    algorithm
      ...
      elseif (region == 3) then
        ...
        f := BaseIF97.Basic.f3(d, T);
        pro :=
          ThermofluidStream.Media.myMedia.Common.ThermoFluidSpecial.helmholtzToProps_pT(
          f);
      elseif (region == 5) then
        g := BaseIF97.Basic.g5(p, T);
        pro :=

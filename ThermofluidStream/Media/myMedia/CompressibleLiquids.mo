...
package CompressibleLiquids "Compressible liquid models"
  ...
  package Common "Base classes for compressible liquids"
    ...
    partial package LinearWater_pT
      ...
      extends myMedia.Interfaces.PartialLinearFluid(
        ...
        reference_d=ThermofluidStream.Media.myMedia.Water.StandardWater.density(
            state),
        reference_h=
            ThermofluidStream.Media.myMedia.Water.StandardWater.specificEnthalpy(
            state),
        reference_s=
            ThermofluidStream.Media.myMedia.Water.StandardWater.specificEntropy(
            state),
        cp_const=
            ThermofluidStream.Media.myMedia.Water.StandardWater.specificHeatCapacityCp(
            state),
        beta_const=
            ThermofluidStream.Media.myMedia.Water.StandardWater.isobaricExpansionCoefficient(
            state),
        kappa_const=
            ThermofluidStream.Media.myMedia.Water.StandardWater.isothermalCompressibility(
            state),
        MM_const=ThermofluidStream.Media.myMedia.Water.StandardWater.molarMass(
            state));

      constant
        ThermofluidStream.Media.myMedia.Water.StandardWater.ThermodynamicState state=
          ThermofluidStream.Media.myMedia.Water.StandardWater.setState_pT(
  ...
  package LinearWater_pT_Ambient
    ...
    extends
      ThermofluidStream.Media.myMedia.CompressibleLiquids.Common.LinearWater_pT(

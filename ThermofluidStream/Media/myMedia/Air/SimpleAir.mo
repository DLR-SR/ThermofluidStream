...
package SimpleAir "Air: Simple dry air model (0..100 degC)"
  ...
  constant
    ThermofluidStream.Media.myMedia.Interfaces.Types.Basic.FluidConstants[nS] airConstants={
      ...
      molarMass=ThermofluidStream.Media.myMedia.IdealGases.Common.SingleGasesData.N2.MM)}
